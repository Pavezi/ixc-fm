...
let Inserir = {
  ...
  cliente: async (token) => {
    ...
    let rando = random.nome();

    let randomCPF = Math.floor(Math.random());
    ...
    let params = {
      ...
      cnpj_cpf: randomCPF,
      email: `lorenzo+${Math.floor(
        Math.random() * (2000 - 1 + 1) + 1
      )}@fidelizou.me`,
  ...
  cliente_contrato: async (token) => {
    ...
    let params = {
      ...
      id_filial: "1",
      id_vd_contrato: "1",
      contrato: "teste contrato",
      id_tipo_contrato: "1",
      id_modelo: "1",
      data: "16/02/2023",
      descricao_aux_plano_venda: "venda",
  ...
  cliente_contrato_desc_serv: async (token, params) => {
    ...
    await request(options, params);
    // let cliente_contrato_desc_serv =
  },
  ...
  cliente_contrato_produtos_reajuste_valor: async (token, params) => {
    ...
    await request(options, params);
    // let cliente_contrato_produtos_reajuste_valor =
  },
  cliente_contrato_servicos_param: async (token, params) => {
    ...
    await request(options, params);
    // let cliente_contrato_servicos_param =
  },
  ...
  cnf_classificacao_tributaria: async (token, params) => {
    ...
    await request(options, params);
    // let cnf_classificacao_tributaria =
  },
  ...
  radpop_radio_cliente_fibra: async (token, params) => {
    ...
    await request(options, params);
    // let radpop_radio_cliente_fibra =
  },
  radpop_radio_cliente_fibra_perfil: async (token, params) => {
    ...
    await request(options, params);
    // let radpop_radio_cliente_fibra_perfil =
  },
  ...
  usuarios: async (token) => {
    ...
    for (let index = 0, length = 2; index < length; index += 1) {
      let params = {
        nome: `Teste Devs ${20 + index}`,
        email: `emailDev${20 + index}@fidelizou.me`,
      };
  ...
  view_voip_sippeers_cliente: async (token, params) => {
    ...
    await request(options, params);
    // let view_voip_sippeers_cliente =
  },
