...
let options = { method: 'POST',
  url: 'https://HOST/webservice/v1/empresa_setor',
  headers:
   {
...
let options = { method: 'DELETE',
  url: 'https://HOST/webservice/v1/empresa_setor/Id_a_deletar',
  headers:
   {
     'Content-Type': 'application/json',
     Authorization: 'Basic ' + new Buffer.from(token).toString('base64')
...
let options = { method: 'PUT',
  url: 'https://HOST/webservice/v1/empresa_setor/Id_a_editar',
  headers:
   {
     'Content-Type': 'application/json',
     Authorization: 'Basic ' + new Buffer.from(token).toString('base64')
